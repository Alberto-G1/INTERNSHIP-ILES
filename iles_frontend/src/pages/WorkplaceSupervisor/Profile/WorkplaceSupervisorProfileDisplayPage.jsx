// Workplace Supervisor Profile Display Page - Read-only profile view
...
const WorkplaceSupervisorProfileDisplayPage = () => {
  const { user } = useAuth();
  ...
  const completionPercent = Math.max(0, Math.min(100, Number(supervisorProfile.completion_percentage) || 0));
    ...
    <Container maxWidth="md" sx={{ py: 4 }}>
      ...
      <Box sx={{ mb: 4, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <Box>
          ...
          <Typography variant="body2" color="textSecondary">
            View your workplace supervision information
          </Typography>
        </Box>
        <Button
          variant="contained"
        ...
        <CardContent>
          ...
          <Grid container spacing={3}>
            ...
            <Grid item xs={12} sm={6}>
              ...
              <Typography variant="body2">{supervisorProfile.organization_type || 'N/A'}</Typography>
            </Grid>
            <Grid item xs={12} sm={6}>
              <Typography variant="caption" color="textSecondary">Industry</Typography>
              <Typography variant="body2">{supervisorProfile.industry || 'N/A'}</Typography>
            </Grid>
            <Grid item xs={12} sm={6}>
              <Typography variant="caption" color="textSecondary">Location</Typography>
              <Typography variant="body2">{supervisorProfile.location || 'N/A'}</Typography>
            </Grid>
            <Grid item xs={12} sm={6}>
            ...
            <Grid item xs={12} sm={6}>
              <Typography variant="caption" color="textSecondary">Position/Title</Typography>
      ...
      <Card sx={{ mb: 3 }}>
        <CardContent>
          ...
          <Grid container spacing={3}>
            <Grid item xs={12} sm={6}>
              <Typography variant="caption" color="textSecondary">Work Email</Typography>
            ...
            <Grid item xs={12} sm={6}>
              <Typography variant="caption" color="textSecondary">Work Phone</Typography>
              <Typography variant="body2">{supervisorProfile.work_phone || 'N/A'}</Typography>
            </Grid>
            <Grid item xs={12}>
