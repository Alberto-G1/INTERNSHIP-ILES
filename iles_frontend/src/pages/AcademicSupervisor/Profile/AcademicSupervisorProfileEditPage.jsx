// Academic Supervisor Profile Edit Page - Editable profile form
...
const AcademicSupervisorProfileEditPage = () => {
  const { user } = useAuth();
    ...
    <Container maxWidth="md" sx={{ py: 4 }}>
      ...
      <Box sx={{ mb: 4 }}>
        <Typography variant="h4" gutterBottom sx={{ fontWeight: 600 }}>
          Edit Academic Supervisor Profile
        </Typography>
        <Typography variant="body2" color="textSecondary">
          Update your academic supervision information
        </Typography>
      </Box>
...
export default AcademicSupervisorProfileEditPage;
